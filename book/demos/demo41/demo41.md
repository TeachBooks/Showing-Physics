...
Ask a student to keep the tubes closed with their fingers to prevent the water from flowing out (see {numref}`Figure {number} <demo41_fig1>`). Fill both bottles to the same height with water.
